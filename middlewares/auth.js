...
exports.restrictTo = exports.checkAuth = void 0;
...
const checkAuth = async (req, res, next) => {
    ...
    const user = (0, auth_js_1.getUser)(token); // to get the user(payload)
    ...
    const dbUser = await user_js_1.default.findOne({ _id: user._id });
    if (!dbUser) {
